...
export default function StatCard({ title, stat1, stat2, stat3, chartTitle, chartData, chartLabels, msg1, msg2, msg3, spaced, red }) {
      ...
      <div className="cardBack">
        ...
        <div className="cardContent">
          <div className="cardGraph">
            {/* pass Line/Bar Graph prop to <Graㅏㅓph /> */}
            { chartData && (
