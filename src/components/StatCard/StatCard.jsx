...
export default function StatCard({
  ...
  console.log('stat3 from StatCard component', stat3);
  ...
  return (
    <ReactCardFlip
      isFlipped={isFlipped}
      containerClassName={spaced ? 'statCard spaced' : 'statCard'}
    >
      <div className="cardFront">
        ...
        <div className="cardContent">
          <div className="stat1Container">
            ...
            {msg1 && <div className="msg1">&nbsp;&nbsp;{msg1}</div>}
          </div>
          {stat2 && (
      ...
      <div className="cardBack">
        <div className="cardHeader">
          ...
          <div className="cardTitle">{chartTitle}</div>
        </div>
        <div className="cardContent">
          <div className="cardGraph">
            {/* pass Line/Bar Graph prop to <Graph /> */}
            {chartData && (
