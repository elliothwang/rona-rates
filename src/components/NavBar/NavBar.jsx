        ...
        <div className="sideNavButtonContainer">
          <div className="sideNavButton" onClick={handleArrowClick}>
            <div className="closeArrowIcon hidden">
              <svg xmlns="http://www.w3.org/2000/svg" width="3.75vmin" height="3.75vmin" fill="currentColor" className="bi bi-arrow-bar-right" viewBox="0 0 16 16">
            ...
            <div className="openArrowIcon">
              <svg xmlns="http://www.w3.org/2000/svg" width="3.75vmin" height="3.75vmin" fill="currentColor" className="bi bi-arrow-bar-left" viewBox="0 0 16 16">
