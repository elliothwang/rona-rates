  ...
  return (
    <nav>
      <div className="topNavBar">
        ...
        <div>
          { user && (
            <NavLink to="/mycounty" exact className="myCountyTopNav flex-ctr-ctr" name="activeMyCounty" activeStyle={{color : "#172121", borderTop : "0.2vmin solid #dce4e9"}}>My County</NavLink>
          )}
      ...
      <div className="sideNavBar">
        ...
        { user && (
          <NavLink to="/mycounty" exact className="myCountySideNav" name="activeMyCounty" activeStyle={{color : "#dce4e9"}} onClick={openOrCloseSideNav}>My County</NavLink>
        )}
